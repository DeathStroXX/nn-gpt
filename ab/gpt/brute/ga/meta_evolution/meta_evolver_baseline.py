...
ARCH_DIR = os.path.join(BASE_DIR, 'baseline_ga_fractal_arch') 
STATS_DIR = os.path.join(BASE_DIR, 'baseline_stats')
# CHECKPOINT = 'fractal_ga_ckpt.pkl'
# CHECKPOINT = os.path.join(BASE_DIR, 'baseline_ga_ckpt.pkl')
CHECKPOINT = os.path.join(BASE_DIR, 'fractal_baseline_save_point.pkl')
BEST_STATS_DIR = os.path.join(BASE_DIR, 'best_baseline_stats')
...
if __name__ == "__main__":
    ...
    try:
        ...
        if best:
             ...
             best_path = os.path.join(BASE_DIR, "best_baseline_model.py")
             ...
             info_path = os.path.join(BASE_DIR, "best_baseline_info.json")
             best_info = {
                 "timestamp": datetime.now().isoformat(),
        ...
        print(f"[Run] Saved baseline trajectory to baseline_results.json")

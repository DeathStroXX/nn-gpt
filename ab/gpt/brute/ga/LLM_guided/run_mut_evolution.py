...
import time
import hashlib
from ab.gpt.brute.ga.LLM_guided.MutNet_evolvable import Net, SEARCH_SPACE, generate_model_code_string
from ab.gpt.brute.ga.LLM_guided.genetic_algorithm import GeneticAlgorithm
...
def fitness_function(chromosome: dict) -> float:
    ...
    try:
        ...
        evaluator = Eval(
            ...
            metric='acc',
            prm=eval_prm,
            save_to_db=False, # Disable DB to avoid schema-dependent failures during eval
